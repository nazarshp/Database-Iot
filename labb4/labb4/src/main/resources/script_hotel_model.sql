...
-- Schema hotel_model
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `hotel_model` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
drop table IF EXISTS `hotel_model`.`hotel` ;

create TABLE IF NOT EXISTS `hotel_model`.`hotel` (
...
-- -----------------------------------------------------
drop table IF EXISTS `hotel_model`.`client` ;

create TABLE IF NOT EXISTS `hotel_model`.`client` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
...
-- Table `review`
-- -----------------------------------------------------
drop table IF EXISTS `hotel_model`.`review` ;

create TABLE IF NOT EXISTS `hotel_model`.`review` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- Table `location`
-- -----------------------------------------------------
drop table IF EXISTS `hotel_model`.`location` ;

create TABLE IF NOT EXISTS `hotel_model`.`location` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- Table `reserved`
-- -----------------------------------------------------
drop table IF EXISTS `hotel_model`.`reserved` ;

create TABLE IF NOT EXISTS `hotel_model`.`reserved` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- Table `payment`
-- -----------------------------------------------------
drop table IF EXISTS `hotel_model`.`payment` ;

create TABLE IF NOT EXISTS `hotel_model`.`payment` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `date` DATE NOT NULL,
  `suma` FLOAT NOT NULL,
...
-- Table `room`
-- -----------------------------------------------------
drop table IF EXISTS `hotel_model`.`room` ;

create TABLE IF NOT EXISTS `hotel_model`.`room` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `hotel_id` INT NOT NULL,
...
-- Table `hotel_model`.`hotel`
-- -----------------------------------------------------
insert into  `hotel_model`.`hotel` ( `name`, `phone`, `hotel_code` ) values
...
-- Table `hotel_model`.`client`
-- -----------------------------------------------------
insert into  `hotel_model`.`client` ( `name`, `surname`, `phone_number`, `email`, `gender` )
values
...
-- -----------------------------------------------------
insert into  `hotel_model`.`review` ( `raiting`, `description`, `date`, `client_id`, `hotel_id` )
values
...
-- -----------------------------------------------------
insert into  `hotel_model`.`location` ( `city`, `street`, `hotel_id` )
values
('Lviv', 'Schevchenka', 1),
('Odesa', 'Zhukovsky', 2),
('Warsaw', 'Ratuszowa', 3),
...
-- -----------------------------------------------------
insert into  `hotel_model`.`reserved` ( `from_date`, `to_date`, `client_id` )
values
...
-- -----------------------------------------------------
insert into  `hotel_model`.`payment` ( `date`, `suma`, `reserved_id` )
values
('2022-04-09', 5000, 10),
('2021-07-01', 1500, 9),
('2022-05-13', 3000, 8),
...
-- -----------------------------------------------------
insert into  `hotel_model`.`room` (`number`, `type`, `floor`, `price`, `hotel_id`, `reserved_id` )
values
