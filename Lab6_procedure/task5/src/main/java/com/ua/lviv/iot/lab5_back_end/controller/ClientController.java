...
public class ClientController {
    ...
    @PostMapping(value = "/add-nonames")
    public void addNonames() throws ParseException {
        clientService.addNonames();
    }
    @PostMapping(value = "/call-adding-client-procedure")
    public void callAddingClientProcedure(@RequestBody ClientDto clientDto){
        clientService.callAddingClientProcedure(clientDto);
    }
    @PostMapping(value = "/add-two-tables")
    public void addTwoTables(){
        clientService.addTwoTables();
    }
